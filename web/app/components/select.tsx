  ...
  return (
    <SelectPrimitive.Root {...props}>
      <SelectPrimitive.Trigger
        className={cn(
          "flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border px-3 py-2 text-sm shadow-sm data-[placeholder]:text-gray-400 [&>span]:line-clamp-1",
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          position={position}
          className={cn(
            "relative z-50 max-h-[--radix-select-content-available-height] min-w-[8rem] overflow-y-auto overflow-x-hidden rounded-md border shadow-md origin-[--radix-select-content-transform-origin]",
