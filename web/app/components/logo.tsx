...
export const Logo = () => {
  return (
    <NavLink
      to="/"
      className="group/logo flex items-center space-x-3 leading-0"
    >
      <div className="group-hover/logo:animate-tada flex h-8 w-8 items-center justify-center rounded-lg border border-gray-700 bg-gray-800">
        <svg
      ...
      <span className="text-lg text-gray-200">
        tailwindcss <span className="font-semibold">animate</span>
      </span>
    </NavLink>
  );
};
